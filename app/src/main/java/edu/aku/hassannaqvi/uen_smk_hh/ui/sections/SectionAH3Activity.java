...
public class SectionAH3Activity extends AppCompatActivity {
    ...
    private void SaveDraft() throws JSONException {
        ...
        json.put("ah24011", bi.ah24011.isChecked() ? "98" : "-1");
        ...
        json.put("ah26", bi.ah26a.isChecked() ? "1"
                ...
                : bi.ah26d.isChecked() ? "4"
                : bi.ah26e.isChecked() ? "5"
                : bi.ah26f.isChecked() ? "6"
                : bi.ah26g.isChecked() ? "7"
                : bi.ah26h.isChecked() ? "8"
                : bi.ah26i.isChecked() ? "9"
                : bi.ah26j.isChecked() ? "10"
                : "-1");
        ...
        json.put("ah3002", bi.ah3002a.isChecked() ? "1"
                : bi.ah3002b.isChecked() ? "2"
                : bi.ah3002c.isChecked() ? "3"
                : "-1");

        json.put("ah3003", bi.ah3003a.isChecked() ? "1"
                : bi.ah3003b.isChecked() ? "2"
                : bi.ah3003c.isChecked() ? "3"
                : "-1");
