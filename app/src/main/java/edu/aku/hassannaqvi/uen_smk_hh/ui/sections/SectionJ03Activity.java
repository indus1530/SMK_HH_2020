...
public class SectionJ03Activity extends AppCompatActivity {
    ...
    private void SaveDraft() throws JSONException {
        ...
        json.put("j113", bi.j113.getText().toString().trim().isEmpty() ? "-1" : bi.j113.getText().toString());
        ...
        json.put("j116", bi.j116.getText().toString().trim().isEmpty() ? "-1" : bi.j116.getText().toString());
        ...
        json.put("j118", bi.j118.getText().toString().trim().isEmpty() ? "-1" : bi.j118.getText().toString());
        ...
        json.put("j121", bi.j121.getText().toString().trim().isEmpty() ? "-1" : bi.j121.getText().toString());
        ...
        json.put("j123a", bi.j123a.isChecked() ? "1" : "-1");
        json.put("j123b", bi.j123b.isChecked() ? "2" : "-1");
        json.put("j123c", bi.j123c.isChecked() ? "3" : "-1");
        json.put("j123d", bi.j123d.isChecked() ? "4" : "-1");
        json.put("j123e", bi.j123e.isChecked() ? "5" : "-1");
        json.put("j123f", bi.j123f.isChecked() ? "6" : "-1");
        json.put("j123g", bi.j123g.isChecked() ? "7" : "-1");
        json.put("j123h", bi.j123h.isChecked() ? "8" : "-1");
        json.put("j123i", bi.j123i.isChecked() ? "9" : "-1");
        json.put("j123j", bi.j123j.isChecked() ? "10" : "-1");
        json.put("j123k", bi.j123k.isChecked() ? "11" : "-1");
        json.put("j123l", bi.j123l.isChecked() ? "12" : "-1");
        json.put("j123m", bi.j123m.isChecked() ? "13" : "-1");
        json.put("j123n", bi.j123n.isChecked() ? "14" : "-1");
        json.put("j123o", bi.j123o.isChecked() ? "15" : "-1");
        json.put("j123p", bi.j123p.isChecked() ? "16" : "-1");
        json.put("j123q", bi.j123q.isChecked() ? "17" : "-1");
        json.put("j123r", bi.j123r.isChecked() ? "18" : "-1");
        json.put("j123s", bi.j123s.isChecked() ? "19" : "-1");
        json.put("j123t", bi.j123t.isChecked() ? "20" : "-1");
        json.put("j123u", bi.j123u.isChecked() ? "21" : "-1");
        json.put("j123v", bi.j123v.isChecked() ? "22" : "-1");
        json.put("j12398", bi.j12398.isChecked() ? "98" : "-1");
        json.put("j12396", bi.j12396.isChecked() ? "96" : "-1");
        json.put("j12396x", bi.j12396x.getText().toString().trim().isEmpty() ? "-1" : bi.j12396x.getText().toString());
