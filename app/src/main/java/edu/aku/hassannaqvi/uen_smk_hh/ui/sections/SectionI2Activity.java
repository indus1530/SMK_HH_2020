...
public class SectionI2Activity extends AppCompatActivity {
    ...
    private void SaveDraft() throws JSONException {
        ...
        json.put("i202", bi.i202.getText().toString().trim().isEmpty() ? "-1" : bi.i202.getText().toString());

        json.put("i203", bi.i203a.isChecked() ? "1"
                : bi.i203b.isChecked() ? "2"
                : "-1");

        json.put("i204", bi.i204.getText().toString().trim().isEmpty() ? "-1" : bi.i204.getText().toString());
        ...
        json.put("i206", bi.i206.getText().toString().trim().isEmpty() ? "-1" : bi.i206.getText().toString());
        ...
        json.put("i208", bi.i208a.isChecked() ? "1"
                ...
                : bi.i208i.isChecked() ? "9"
                : bi.i208j.isChecked() ? "10"
                : bi.i208k.isChecked() ? "11"
                : bi.i208l.isChecked() ? "12"
                : bi.i208m.isChecked() ? "13"
                : bi.i208n.isChecked() ? "14"
                : "-1");
        ...
        json.put("i211", bi.i211.getText().toString().trim().isEmpty() ? "-1" : bi.i211.getText().toString());

        json.put("i212", bi.i212.getText().toString().trim().isEmpty() ? "-1" : bi.i212.getText().toString());

        json.put("i213", bi.i213a.isChecked() ? "1" :
                bi.i213b.isChecked() ? "2" :
                        bi.i213c.isChecked() ? "3" :
                                bi.i213d.isChecked() ? "4" :
                                        bi.i213e.isChecked() ? "5" : "-1");

        json.put("i214", bi.i214a.isChecked() ? "1" :
                bi.i214b.isChecked() ? "2" : "-1");

        json.put("i215", bi.i215a.isChecked() ? "1" :
                bi.i215b.isChecked() ? "2" :
                        bi.i215c.isChecked() ? "3" : "-1");

        json.put("i216", bi.i216.getText().toString().trim().isEmpty() ? "-1" : bi.i216.getText().toString());

        json.put("i217", bi.i217a.isChecked() ? "1" :
                bi.i217b.isChecked() ? "2" :
                        bi.i217c.isChecked() ? "98" : "-1");

        json.put("i218a", bi.i218a.isChecked() ? "1" : "-1");
        json.put("i218b", bi.i218b.isChecked() ? "2" : "-1");
        json.put("i218c", bi.i218c.isChecked() ? "3" : "-1");
        json.put("i218d", bi.i218d.isChecked() ? "4" : "-1");
        json.put("i218e", bi.i218e.isChecked() ? "5" : "-1");
        json.put("i218f", bi.i218f.isChecked() ? "6" : "-1");
        json.put("i218g", bi.i218g.isChecked() ? "7" : "-1");
        json.put("i218h", bi.i218h.isChecked() ? "8" : "-1");
        json.put("i218i", bi.i218i.isChecked() ? "9" : "-1");
        json.put("i218j", bi.i218j.isChecked() ? "10" : "-1");
        json.put("i218k", bi.i218k.isChecked() ? "11" : "-1");
        json.put("i218l", bi.i218l.isChecked() ? "12" : "-1");
        json.put("i218m", bi.i218m.isChecked() ? "13" : "-1");
        json.put("i218n", bi.i218n.isChecked() ? "14" : "-1");
        ...
        json.put("i221", bi.i221.getText().toString().trim().isEmpty() ? "-1" : bi.i221.getText().toString());
...
/*
        ...
        json.put("i223a", bi.i223a.isChecked() ? "1" : "-1");
        json.put("i223b", bi.i223b.isChecked() ? "2" : "-1");
        json.put("i223c", bi.i223c.isChecked() ? "3" : "-1");
        json.put("i223d", bi.i223d.isChecked() ? "4" : "-1");
        json.put("i223e", bi.i223e.isChecked() ? "5" : "-1");
        json.put("i223f", bi.i223f.isChecked() ? "6" : "-1");
        json.put("i223g", bi.i223g.isChecked() ? "7" : "-1");

        json.put("i224a", bi.i224a.isChecked() ? "1" : "-1");
        json.put("i224b", bi.i224b.isChecked() ? "2" : "-1");
        json.put("i224c", bi.i224c.isChecked() ? "3" : "-1");
        json.put("i224d", bi.i224d.isChecked() ? "4" : "-1");
        json.put("i224e", bi.i224e.isChecked() ? "5" : "-1");
        json.put("i224f", bi.i224f.isChecked() ? "6" : "-1");
       ...
       /* f2.put("i226", bi.i226a.isChecked() ? "1" :
        ...
        json.put("i225aa", bi.i2252a.isChecked() ? "1" : "-1");
        json.put("i225ab", bi.i2252b.isChecked() ? "2" : "-1");
        json.put("i225ac", bi.i2252c.isChecked() ? "3" : "-1");
        json.put("i225ad", bi.i2252d.isChecked() ? "3a" : "-1");
        json.put("i225ae", bi.i2252e.isChecked() ? "3b" : "-1");
        json.put("i225af", bi.i2252f.isChecked() ? "3c" : "-1");
        json.put("i225ag", bi.i2252g.isChecked() ? "3d" : "-1");


        json.put("i226a", bi.i226a.isChecked() ? "1" : "-1");
        json.put("i226b", bi.i226b.isChecked() ? "2" : "-1");
        json.put("i226c", bi.i226c.isChecked() ? "3" : "-1");
        json.put("i226d", bi.i226d.isChecked() ? "4" : "-1");
        json.put("i226e", bi.i226e.isChecked() ? "5" : "-1");
        json.put("i226f", bi.i226f.isChecked() ? "6" : "-1");
