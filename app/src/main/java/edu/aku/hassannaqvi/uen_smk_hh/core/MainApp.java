...
public class MainApp extends Application {
    ...
    public static final String _HOST_URL = MainApp._IP + "/smk_bl/api/";// .TEST server;
    ...
    public static final String _UPDATE_URL = MainApp._IP + "/smk_bl/app/hh/" + LANGUAGE_CODE_UR + "/";
    ...
    public static int genderFlag = -1;
